const Footer = () => {
  return (
    <footer className="bg-gray-900 p-10 font-[sans-serif] tracking-wide mt-20">
      ...
      <p className="text-gray-300 text-sm mt-10">
        ...
        <span style={{ color: "yellow" }}>Talent</span>{" "}
        <span style={{ color: "red" }}>Habesha</span>. All rights reserved.
      </p>
    </footer>
  );
};
